...
class GPT2Wrapper(ModelWrapper):
    ...
    def generate_self_debiasing(self, input_texts: List[str], debiasing_prefixes: List[str], decay_constant: float = 50,
        ...
        outputs = self._model.generate(**inputs, min_length=min_length, max_length=max_length, **kwargs)
        ...
        outputs.scores = outputs.scores[:batch_size, inputs['input_ids'].shape[1]-1:-1, :]  # Align scores with output_ids
